...
var screenheight = 0; var screenwidth = 0;
var animatetime = '5s';
var infopageactivated = false; var hviewactivated = false;

var scalefinish = false;

var smallsite = false; mobilesite = false;
...
function horizontalchange(elenum,first) //HView Change(Move) Element
{
	...
	var locx = 0; locy = 0; scalex = 1; scaley = 1;
...
window.onorientationchange = function() {JScale();} // For Tablet Devices
